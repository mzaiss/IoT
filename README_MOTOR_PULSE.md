...
Diese Anleitung und `motor_pulse_scare.js` liegen auf dem Branch **`cursor/rehwild-motor-puls-shelly1-eee1`**. Die PV-Überschusssteuerung (`pv_heater_control.js` / `README.md`) bleibt davon unabhängig auf `main`.
